    ...
    function (homeHtml) {
      ...
      //
       var homeHtmlToInsertIntoMainPage = 
            buildMenuItemsViewHtml1(chosenCategoryShortName,
                                   menuItemsTitleHtml,
                                   homeHtmlUrl);
...
dc.loadMenuItems1 = function (categoryShort) {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    homeHtmlUrl + categoryShort,
...
function buildMenuItemsViewHtml1(categoryMenuItems,
                                menuItemsTitleHtml,
                                menuItemHtml) {
